...
import 'request_admin_model.dart';
export 'request_admin_model.dart';

class RequestAdminWidget extends StatefulWidget {
  const RequestAdminWidget({
    super.key,
  ...
  @override
  State<RequestAdminWidget> createState() => _RequestAdminWidgetState();
}

class _RequestAdminWidgetState extends State<RequestAdminWidget> {
  late RequestAdminModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RequestAdminModel());
                    ...
                    child: Column(
                      ...
                      children: [
                          ...
                          children: [
                              ...
                              builder: (context) {
                                ...
                                return SingleChildScrollView(
                                  ...
                                  child: Row(
                                    ...
                                    mainAxisAlignment: MainAxisAlignment.start,
                                    children:
                                        List.generate(uploadedPhotos.length,
                                            (uploadedPhotosIndex) {
                            ...
                            TextFormField(
                              controller: _model.textController2 ??=
                                  TextEditingController(
                                text: bottomSheetEditOrdersRecord.carYear
                                    .toString(),
                              ),
                            ...
                            TextFormField(
                              controller: _model.textController3 ??=
                                  TextEditingController(
                                text: bottomSheetEditOrdersRecord.mileage
                                    .toString(),
                              ),
                            ...
                            TextFormField(
                              controller: _model.textController4 ??=
                                  TextEditingController(
                                text: bottomSheetEditOrdersRecord.engineType,
                              ),
                            ...
                            TextFormField(
                              controller: _model.textController6 ??=
                                  TextEditingController(
                                text: bottomSheetEditOrdersRecord.bodyColor,
                              ),
                        ...
                        Row(
                          ...
                          children: [
                            if (bottomSheetEditOrdersRecord.hasApproved()
                                ? false
                                : true)
                              FFButtonWidget(
                                onPressed: () async {
                                  await bottomSheetEditOrdersRecord.reference
