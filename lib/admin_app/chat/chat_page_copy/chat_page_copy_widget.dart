  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<ChatsRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<ChatsRecord> chatPageCopyChatsRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final chatPageCopyChatsRecord = chatPageCopyChatsRecordList.isNotEmpty
            ? chatPageCopyChatsRecordList.first
            : null;
                  ...
                  Expanded(
                    child: StreamBuilder<List<ChatMessagesRecord>>(
                      stream: queryChatMessagesRecord(
                        parent: chatPageCopyChatsRecord?.reference,
                            ...
                            onPressed: (_model.textController.text == '')
                                ...
                                : () async {
                                    await ChatMessagesRecord.createDoc(
                                            chatPageCopyChatsRecord!.reference)
                                    ...
                                    await chatPageCopyChatsRecord.reference
